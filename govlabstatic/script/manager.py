...
class Manager(object):
    ...
    def _patch_argparser(self, parser):
        """
        Patches the parser to print the full help if no arguments are
        supplied.
        """
    ...
    def add_option(self, *args, **kwargs):
        ...
        function rather than an App instance. Otherwise any options you set
        will be ignored.
    ...
    def __call__(self, app=None, **kwargs):
        ...
        If your sub-Manager does not override this, any values for
        options will get lost.
        """
        if app is None:
            app = self.app
            if app is None:
                raise Exception("There is no app here. This is unlikely "
                                "to work.")
    ...
    def handle(self, prog, args=None):
        ...
        if remaining_args and not getattr(last_func, 'capture_all_args',
                                          False):
        ...
        for handle in func_stack:
            ...
            if handle is last_func and getattr(last_func, 'capture_all_args',
                                               False):
